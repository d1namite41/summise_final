...
import 'Unused/summary_page.dart';
...
import 'firebase/sign_up_page.dart';
//import 'package:firebase_core/firebase_core.dart';
  ...
  if (kIsWeb) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: "AIzaSyB8QAkGVUFFy4Y-bL-naxgcribOq_dgTfE",
        appId: "1:423533663366:web:f2cada67e27c1ebb6b2d07",
        messagingSenderId: "423533663366",
        projectId: "rew-fec44",
      ),
    );
  } else {
...
void get_summary() async {
  final apiKey = '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';
  ...
  final body = json.encode({
    'prompt': 'Summerise this text: ' + _lastWords,
    'temperature': 0.5,
    'max_tokens': 50,
    'model': 'davinci',
  });
